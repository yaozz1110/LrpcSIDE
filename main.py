...
def return_arguments():
    ...
    parser.add_argument('--data_test_dir', default='',
                        help='path to the dataset folder. \
                            It should contain subfolders with following structure:\
                            "image_02/data" for left images and \
                            "image_03/data" for right images'
...
class Model:
    ...
    def __init__(self, args):
        ...
        if args.mode == 'train':
            self.loss_function = MonodepthLoss(args.input_size,
                n=4,
                SSIM_w=0.85,
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            self.save(os.path.join(self.args.model_path, 'nonlocal100_cpt.pth'))
