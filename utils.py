...
# from models_resnet import Resnet18_md, Resnet101_md, Resnet50_md
...
#     if model == 'resnet101_md':
#         out_model = Resnet101_md(input_channels)#model = ResNet_context(num_classes, disable_self_attn=False, pretrained=True)
